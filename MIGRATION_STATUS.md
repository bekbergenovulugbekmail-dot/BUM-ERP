...
4. **Desktop POS (K1–K6) — qolgan:**
   - o'rnatuvchi 0.3.2 (`apps/desktop/release/BUM-POS-KASSA-Setup-0.3.2.exe`, SHA-256 `BE6A7AA98705CF7992E7E545A9B63B76936C0FDAAA3FC959BFBD9E3B631CD7E6`, imzosiz; 0.3.2 — kassa ekranidagi Menyu yangi ko'rinishda: guruhlar, ikonkalar, sozlamadagi qaynoq tugmalar, kassir kartasi) — platforma admini Admin → "Desktop kassa" orqali yuklab e'lon qiladi (bo'laklab, davom ettiriladigan); o'rnatilgan kassalar Sozlamalar → Ilova versiyasi'dan yangilanadi
