...
/**
 * Do'kon sahifasida so'nggi yuborilgan buyurtmalar. Tashrifsiz buyurtma ruxsat etilgan bo'lsa — "Buyurtma berish"
 * tugmasi ham; aks holda buyurtma tashrif panelidagi "BUYURTMA" orqali (rasmlardan keyin).
 */
export default function OrderEntry({ customerId }: { customerId: string }) {
  ...
  return (
    <div className="space-y-2">
      {policy && !policy.orderRequiresVisit && (
